package com.nannan.widget.material;
    ...
    private class Builder {
        ...
        private Builder() {
            ...
            View contentView = LayoutInflater.from(mContext)
                                             .inflate(
                                                     R.layout.lib_layout_material_dialog,
                                                     null);
            contentView.setFocusable(true);
            contentView.setFocusableInTouchMode(true);

            mAlertDialogWindow.setBackgroundDrawableResource(
                    R.drawable.lib_dlg_material_dialog_window);
        ...
        public void setPositiveButton(String text, final View.OnClickListener listener) {
            ...
            button.setBackgroundResource(R.drawable.lib_dlg_material_card);
