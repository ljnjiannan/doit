...
import com.nannan.doit.lib.recyclerview.AdapterDelegatesManager;
...
public abstract class BasePullComplexRecyclerAdapter<T> extends BaseSimpleRecyclerAdapter<T> {
  ...
  protected abstract ItemView setFootView();
